...
/**
 * Simple example that visualizes a couple of cell spaces, their states and transitions.
 */
public class IndoorGMLExample extends SimpleApplication {

    public static void main(String[] args) {
        IndoorGMLExample app = new IndoorGMLExample();
        app.start();
    }
    ...
    private Polygon square(float x, float y) {
        Polygon poly = new Polygon();
        poly.setVertices(Arrays.asList(
                new Vector3d(x, y, 0),
                new Vector3d(x + 2, y, 0),
                new Vector3d(x + 2, y + 2, 0),
                new Vector3d(x, y + 2, 0)
        ));
